...
2. Follow the existing service‑layer conventions — keep controllers thin and put logic in `app/Services`.
3. Run **Pint** (`./vendor/bin/pint`) and **the test suite** (`php artisan test`) before opening a PR.
4. Write descriptive commits and open a **pull request** describing the change and its rationale.
